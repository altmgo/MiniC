use mini_c::ir::ast::{IdentifierDecl, Statement, Type, UserTypeKind, UserTypeMember};
use mini_c::parser::identifiers::identifier_decl;
use mini_c::parser::statement;
use mini_c::parser::types::{type_definition, user_type_decl};
use nom::combinator::all_consuming;

#[test]
fn user_type_definition() {
    assert_eq!(
